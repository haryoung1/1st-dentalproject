...
SELECT N.*, ANAME FROM NOTICEBOARD N, ADMIN A WHERE N.AID=A.AID AND NBNO=4;
...
-- (6) 공지사항 삭제
DELETE FROM NOTICEBOARD WHERE NBNO = 13;
...
INSERT INTO MRBOARD (MRNO, MID, AID, MRTITLE, MRCONTENT, MRGROUP, MRSTEP, MRINDENT, MRIP)
    VALUES (MRBOARD_SEQ.NEXTVAL, 'aaa', null, '예약글4', '예약내용4', MRBOARD_SEQ.CURRVAL, 0, 0, '192.168.1');
...
-- (7) 글 삭제하기 (MRNO로)
DELETE FROM MRBOARD WHERE MRNO = 4;
...
SELECT * FROM CBBOARD WHERE CBNO = 1;
